    ...
    public static void main (String args[]){
        ...
        do{
            ...
            // PROCESSAMENTO && SAIDA DE DADOS
                switch(op){
                    case 1: CadastrarPaciente cadastrarPaciente = new CadastrarPaciente();
                            cadastrarPaciente.renderizar();
                    break;

                    case 2: ListarPaciente listarPaciente = new ListarPaciente();
                            listarPaciente.renderizar();
                    break; 

                    case 3: AlterarPaciente alterarPaciente = new AlterarPaciente();
                            alterarPaciente.renderizar(); 
                    break;

                    case 4: DeletarPaciente deletarPaciente = new DeletarPaciente();
                            deletarPaciente.renderizar();
                    break;

                    case 5: CadastrarMedico cadastrarMedico = new CadastrarMedico();
                            cadastrarMedico.renderizar();
                    break;

                    case 6: ListarMedico listarMedico = new ListarMedico();
                            listarMedico.renderizar();
                    break;

                    case 7: CadastrarConsulta cadastrarConsulta = new CadastrarConsulta();
